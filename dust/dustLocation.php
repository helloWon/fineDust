...
<body>
	...
	<div>
		...
		<div id="map-wrap">
			<div id="map-side">
				...
				<div id="weather_text"><div style="text-align: center;"><br><font color='blue'>7</font>/<font color='orange'>15</font></div></div>
			</div>
			<div id="map"></div>
		</div>
	</div>
    ...
    function displayMarker(locPosition, message) {
		...
		function dustStatus(value25){
			if(parseInt(value25) >= 0 && parseInt(value25) < 16){
			...
			}else if(parseInt(value25) >= 16 && parseInt(value25) < 41){
			...
			}else if(parseInt(value25) >= 41 && parseInt(value25) < 61){
			...
			}else if(parseInt(value25) >= 61 && parseInt(value25) < 101){
			...
			}else if(parseInt(value25) >= 101 && parseInt(value25) < 200){
 ...
 document.getElementById('weather_text').innerHTML = "<div style='text-align: center;'><br><font color='blue'>"+"15"+"</font>/<font color='orange'>"+"8"+"</font>";
